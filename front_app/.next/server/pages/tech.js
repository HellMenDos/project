...
const getServerSideProps = async ()=>{
    const slider = await (0,_utils_fetching__WEBPACK_IMPORTED_MODULE_8__/* .fetchData */ .r)('tech', 'carousel/all/');
    const products = await (0,_utils_fetching__WEBPACK_IMPORTED_MODULE_8__/* .fetchData */ .r)('tech', 'products/all/');
    const work = await (0,_utils_fetching__WEBPACK_IMPORTED_MODULE_8__/* .fetchData */ .r)('tech', 'work/all/');
    const service = await (0,_utils_fetching__WEBPACK_IMPORTED_MODULE_8__/* .fetchData */ .r)('tech', 'service/all/');
    return {
        props: {
            slider,
            products,
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,907,571,62,957,258,349], () => (__webpack_exec__(666)));
